...
def download_ec2pricelist():
    ...
    try:
        conn = http.client.HTTPSConnection(
            'pricing-' +  CW_REGION + '.s3.' + CW_REGION + '.amazonaws.com.cn'
        )
        conn.request(
            'GET',
            '/ec2/index.csv'
        ...
        print(inst)
        logging.error("Could not download the EC2 pricelist from " + 'pricing-' +  CW_REGION + '.s3.' + CW_REGION + '.amazonaws.com.cn')
        exit()
